...
/**
 * Ejemplos de mejoras intermedias de Streams (Java 9, 10, 16, 25).
 * Nivel: Intermedio.
 */
public class EjemplosStreamsMejorasIntermedias 
{
    public static void main( String[] args )
    {
        ...
        // toList (Java 16+) - Alternativa moderna a collect(Collectors.toList())
        System.out.println("toList directo (Java 16+)");
        List<String> listFromStream = Stream.of("red", "green", "blue")
                .map(String::toUpperCase)
